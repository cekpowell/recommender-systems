...
public class Task4 {
    ...
    private static final int FACTORS = 5; // the number of latent factors in the matricies.
    private static final int MIN_ITERATIONS = 25; // the minimum number of iterations the algorithm will perform.
    ...
    public static void run(){
        try{
            ...
            // writing to file
            FileHandler.writeObjectToFileAsString(predictions, new File(Task4.RESULTS_FILE));
